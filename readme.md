...
<body>
    ...
    <div id="seccion2" class="container hidden">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNbVyF70gJwdY6H0FpceiPJzFGo63GJqK-bg&s" alt="Pompurin" width="300">
    ...
    <div id="seccion3" class="container hidden">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlldBVzZ-VHW5esB7cwF7mazvILYYSQ9m66Q&s" alt="Pompurin y Macaroon" width="300">
        ...
        <p class="corner-text">
            Pdta.: <span class="resaltado">Así es</span>, no acepto un no por respuesta te amo JAJAJAJA (no supo cómo hacer que creciera el botón).
        </p>
